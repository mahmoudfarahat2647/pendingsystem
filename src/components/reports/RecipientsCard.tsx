...
export function RecipientsCard({ isLocked }: RecipientsCardProps) {
    const { reportSettings, addEmailRecipient, removeEmailRecipient } = useAppStore();
        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                <div className="flex w-full max-w-sm items-center space-x-2">
                    ...
                    />
                    <Button type="button" onClick={handleAddEmail} size="icon" disabled={isLoading || isLocked}>
