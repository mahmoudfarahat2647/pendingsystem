...
// ─── ChartStyle (injects --color-* CSS vars) ──────────────────────────────────
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
	...
	return (
		<style
			// biome-ignore lint/security/noDangerouslySetInnerHtml: controlled CSS variable injection, no user content
...
function getPayloadConfigFromPayload(
	...
	if (key in config && typeof config[key]?.label === "string") {
		return config[key];
	}
