...
export const chartCssVars = {
	...
	foreground: "var(--chart-foreground, white)",
	foregroundMuted: "var(--chart-foreground-muted, #9ca3af)",
	label: "var(--chart-label, #6b7280)",
	linePrimary: "var(--chart-line-primary, #FFCC00)",
	lineSecondary: "var(--chart-line-secondary, #3B82F6)",
	crosshair: "var(--chart-crosshair, rgba(255,255,255,0.1))",
	grid: "var(--chart-grid, transparent)",
};
