...
>(({ className, inset, children, ...props }, ref) => (
	...
	>
		{children}
		{/* Submenu arrow: direction is part of its meaning (points toward the
		    submenu's opening side), so it mirrors in RTL — unlike a neutral
		    icon such as the Check indicator below. */}
