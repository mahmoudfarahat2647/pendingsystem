                ...
                <div className="flex flex-col items-center text-center space-y-4 pt-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <DialogDescription className="text-slate-400">
                            An order with the same VIN <span className="text-white font-mono">{vin}</span> and Part Number <span className="text-white font-mono">{partNumber}</span> already exists.
                        </DialogDescription>
                    </div>
