...
The Supabase MCP server is active in this project. Codex can directly query tables, run SQL, check logs, and inspect schema using MCP tools — **use this before manually debugging connection issues**.
